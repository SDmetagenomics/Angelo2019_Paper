...
setwd("~/Dropbox/Banfield_Lab_Files/Manuscripts/2018_Angelo_C-N_Overview/FOR_SUBMISSION/Nat_Micro/Reviewer_Response/New_Analysis/Enrichment_Permutation_Test/")


### LOAD DATA ###
Phy_and_Targeted <- read.table("Phy_and_Targeted_Dat_S10.txt", header = T, sep = "\t", stringsAsFactors = F)
#write.table(Phy_and_Targeted, "~/Desktop/Phy_and_Targeted_Dat_S10.txt", quote = F, sep = "\t", row.names = F)
